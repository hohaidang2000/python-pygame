...
class Game:
    ...
    def load_data(self):
        ...
        self.title_font = os.path.join(game_folder , "font","ZOMBIE.TTF")
        self.hud_font = os.path.join(game_folder ,"font","Impacted2.0.ttf")
        ...
        for i in range(3):
            ...
            img = pg.image.load(os.path.join(img_folder , "schoolgirl" , 'schoolgirl_torso_{}.png'
        ...
        for i in WEAPONS:
            img = pg.image.load(os.path.join(img_folder , "weapons", WEAPONS[i]['weapon_img'])).convert_alpha()
            img_rotate = pg.transform.rotate(img, -90)
        ...
        self.mob_img = pg.image.load(os.path.join(img_folder , "mobs" , MOB_IMG)).convert_alpha()
        self.mob2_img = {}
        ...
        for i in range(4):
            ...
            img = pg.image.load(os.path.join(img_folder ,"Doctor",  filename)).convert_alpha()
        ...
        for i in range(9):
            ...
            img = pg.image.load(os.path.join(img_folder ,"Doctor","bolt_strike" , filename)).convert_alpha()
        ...
        for i in range(2):
            ...
            img = pg.image.load(os.path.join(img_folder , "Doctor","battery" , filename)).convert_alpha()
        ...
        self.bullet_images['lg'] = pg.image.load(os.path.join(img_folder , "weapons" , BULLET_IMG)).convert_alpha()
        self.bullet_images['sm'] = pg.transform.scale(self.bullet_images['lg'], (10, 10))
        self.gun_flashes = []
        for img in MUZZLE_FLASHES:
            self.gun_flashes.append(pg.image.load(os.path.join(img_folder , "weapons","muzzle_flash" , img)).convert_alpha())
        self.item_images = {}
        for item in ITEM_IMAGE:
            self.item_images[item] = pg.image.load(os.path.join(img_folder , "items" , ITEM_IMAGE[item]))
        self.splat = pg.image.load(os.path.join(img_folder ,"mobs" , SPLAT)).convert_alpha()
        ...
        for i in range(9):
            ...
            img = pg.image.load(os.path.join(img_folder ,"explo" ,filename)).convert_alpha()
        ...
        for i in range(6):
            ...
            img = pg.image.load(os.path.join(img_folder , "blood" , filename)).convert_alpha()
        ...
        for i in range(4):
            ...
            img = pg.image.load(os.path.join(img_folder , "schoolgirl" , filename)).convert_alpha()
            img = pg.transform.rotate(img.copy(), -90)
    ...
    def new(self):
        ...
        self.map = TiledMap(os.path.join(self.map_folder, self.LEVEL[self.level]))
        ...
        for mob in hits:
            ...
            for bullet in hits[mob]:
                if bullet.damage == WEAPONS['bazuka']['damage']:
                    ...
                    mob.vel += -vec(30, 0).rotate(180-bullet.rot)
